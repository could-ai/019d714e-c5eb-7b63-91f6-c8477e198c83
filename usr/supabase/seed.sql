...
('33333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', format('{"sub":"%s","email":"%s"}', '33333333-3333-3333-3333-333333333333', 'test3@example.com')::jsonb, 'email', current_timestamp, current_timestamp, current_timestamp),
('44444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', format('{"sub":"%s","email":"%s"}', '44444444-4444-4444-4444-444444444444', 'test4@example.com')::jsonb, 'email', current_timestamp, current_timestamp, current_timestamp);